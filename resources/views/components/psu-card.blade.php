<div class="col-md-4 ">
    <div class="card mb-4 box-shadow">
        <img class="card-img-top"
             alt="{{\App\Models\IllustrationImage::find($psu->illustration_image_id)["alt"]}}" style="height: 225px; width: 100%; display: block;"
             src="{{\App\Models\IllustrationImage::find($psu->illustration_image_id)["src"]}}"
